          ...
          {selectedContact && activeTab === "jobpostings" && (
            <div className="space-y-4 py-4 max-h-[60vh] overflow-y-auto">
              ...
              <div className="flex items-start gap-3 p-3 bg-gray-50 rounded-lg">
                ...
                <div>
                  <p className="text-xs text-gray-500 uppercase tracking-wider font-medium">Position</p>
                  <p className="text-gray-900 mt-1">{(selectedContact as unknown as JobOpening).position || "Not specified"}</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3 bg-gray-50 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-gray-900 mt-1">{(selectedContact as unknown as JobOpening).job_role || "Not specified"}</p>
                </div>
              </div>
